...
//        email  : pinotoy@yahoo.com
        ...
        posX  = (screen.width) ? (screen.width - 350) : 450;
        var language = 'br';                // Default Language: en - english ; es - spanish; de - german
        ...
        var scrollLeftMessage = {
                ...
                br : 'Clique para ir para o m?s anterior. Deixe pressionado para passar v?rios meses.'
        };
        ...
        var        monthName = {
                ...
                br : new Array('Janeiro','Fevereiro','Mar?o','Abril','Maio','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro')
        };
        var        monthName2 = {
                ...
                br : new Array('JAN','FEV','MAR','ABR','MAI','JUN','JUL','AGO','SET','OUT','NOV','DEZ')
        };
        ...
        if (startAt==0) {
                dayName = {
                        ...
                        br : new Array('Dom','Seg','Ter','Qua','Qui','Sex','Sab')
                };
        } else {
                dayName = {
                        ...
                        br : new Array('Seg','Ter','Qua','Qui','Sex','Sab','Dom')
                };
        }
        ...
        */
        ...
        function init() {
                if (!ns4)
                {
                        ...
                        if (showToday == 1) {
                                document.getElementById('lblToday').innerHTML =        '<font color="#89051d">' + todayString[language] + ' <a onmousemove="window.status=\''+gotoString[language]+'\'" onmouseout="window.status=\'\'" title="'+gotoString[language]+'" style="'+styleAnchor+'" href="javascript:monthSelected=monthNow;yearSelected=yearNow;constructCalendar();">'+dayName[language][(today.getDay()-startAt==-1)?6:(today.getDay()-startAt)]+', ' + dateNow + ' ' + monthName[language][monthNow].substring(0,3) + ' ' + yearNow + '</a></font>';
                        }

                        sHTML1 = '<span id="spanLeft" style="border:1px solid #fcb815;cursor:pointer" onmouseover="swapImage(\'changeLeft\',\'left2.gif\');this.style.borderColor=\'#ffffff\';window.status=\''+scrollLeftMessage[language]+'\'" onclick="decMonth()" onmouseout="clearInterval(intervalID1);swapImage(\'changeLeft\',\'left1.gif\');this.style.borderColor=\'#fcb815\';window.status=\'\'" onmousedown="clearTimeout(timeoutID1);timeoutID1=setTimeout(\'StartDecMonth()\',500)" onmouseup="clearTimeout(timeoutID1);clearInterval(intervalID1)">&nbsp<img id="changeLeft" src="'+imgDir+'left1.gif" width="10" height="11" border="0">&nbsp</span>&nbsp;';
                        sHTML1 += '<span id="spanRight" style="border:1px solid #fcb815;cursor:pointer" onmouseover="swapImage(\'changeRight\',\'right2.gif\');this.style.borderColor=\'#ffffff\';window.status=\''+scrollRightMessage[language]+'\'" onmouseout="clearInterval(intervalID1);swapImage(\'changeRight\',\'right1.gif\');this.style.borderColor=\'#fcb815\';window.status=\'\'" onclick="incMonth()" onmousedown="clearTimeout(timeoutID1);timeoutID1=setTimeout(\'StartIncMonth()\',500)" onmouseup="clearTimeout(timeoutID1);clearInterval(intervalID1)">&nbsp<img id="changeRight" src="'+imgDir+'right1.gif" width="10" height="11" border="0">&nbsp</span>&nbsp;';
                        sHTML1 += '<span id="spanMonth" style="border:1px solid #fcb815;cursor:pointer" onmouseover="swapImage(\'changeMonth\',\'drop2.gif\');this.style.borderColor=\'#ffffff\';window.status=\''+selectMonthMessage[language]+'\'" onmouseout="swapImage(\'changeMonth\',\'drop1.gif\');this.style.borderColor=\'#fcb815\';window.status=\'\'" onclick="popUpMonth()"></span>&nbsp;';
                        sHTML1 += '<span id="spanYear" style="border:1px solid #fcb815;cursor:pointer" onmouseover="swapImage(\'changeYear\',\'drop2.gif\');this.style.borderColor=\'#ffffff\';window.status=\''+selectYearMessage[language]+'\'" onmouseout="swapImage(\'changeYear\',\'drop1.gif\');this.style.borderColor=\'#fcb815\';window.status=\'\'" onclick="popUpYear()"></span>&nbsp;';
        ...
        function constructMonth() {
                ...
                if (!monthConstructed) {
                        ...
                        for (i=0; i<12; i++) {
                                ...
                                sHTML += '<tr><td id="m' + i + '" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="this.style.backgroundColor=\'\'" style="cursor:pointer" onclick="monthConstructed=false;monthSelected=' + i + ';constructCalendar();popDownMonth();event.cancelBubble=true"><font color="#89051d">&nbsp;' + sName + '&nbsp;</font></td></tr>';
                        }
        ...
        function constructYear() {
                ...
                sHTML = '';
                if (!yearConstructed) {
                        sHTML = '<tr><td align="center" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="clearInterval(intervalID1);this.style.backgroundColor=\'\'" style="cursor:pointer" onmousedown="clearInterval(intervalID1);intervalID1=setInterval(\'decYear()\',30)" onmouseup="clearInterval(intervalID1)"><font color="#89051d">-</font></td></tr>';
                        ...
                        for ( i = (yearSelected-3); i <= (yearSelected+3); i++ ) {
                                ...
                                sHTML += '<tr><td id="y' + j + '" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="this.style.backgroundColor=\'\'" style="cursor:pointer" onclick="selectYear('+j+');event.cancelBubble=true"><font color="#89051d">&nbsp;' + sName + '&nbsp;</font></td></tr>';
                                j++;
                        }

                        sHTML += '<tr><td align="center" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="clearInterval(intervalID2);this.style.backgroundColor=\'\'" style="cursor:pointer" onmousedown="clearInterval(intervalID2);intervalID2=setInterval(\'incYear()\',30)" onmouseup="clearInterval(intervalID2)"><font color="#89051d">+</font></td></tr>';
        ...
        function constructCalendar () {
                ...
                for (i = 0; i<7; i++) {
                        sHTML += '<td width="27" align="right"><b><font color="#89051d">' + dayName[language][i] + '</font></b></td>';
                }
                ...
                for        ( datePointer=1; datePointer <= numDaysInMonth; datePointer++ ) {
                        ...
                        if ((datePointer == dateNow) && (monthSelected == monthNow) && (yearSelected == yearNow)) {        ///// today
                                ...
                                if (isPast==1)
                                        ...
                                        sHTML += "<a "+dateMessage+" title=\"" + sHint + "\" style='"+sStyle+"' "+selDayAction+">&nbsp;<font color=#89051d>" + datePointer + "</font>&nbsp;</a>";
                        }
        ...
        function popUpCalendar(ctl, ctl2, format) {
                ...
                if (bPageLoaded) {
                        if (crossobj.visibility == 'hidden') {
                                ...
                                crossobj.left = (fixedX == -1) ? leftpos - 50 : fixedX;
        ...
        {
          var form = document.pesquisa;
          var totalCampos = form.length;
          ...
          if (campo.value.length >= tamanho)
          {
            ...
            if (nextId <= totalCampos)
            {
              var proximoCampo = document.getElementById(nextId);
              proximoCampo.focus();
            }
          }
        }